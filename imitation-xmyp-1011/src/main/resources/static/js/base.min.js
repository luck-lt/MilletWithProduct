...
;XIAOMI.namespace("app.analytics"), XIAOMI.app.analytics = function (element, options) {
    ...
    for (var _this = this, isUrl = _this.options.url ? !0 : !1, isBDurl = _this.options.BDurl ? !0 : !1, bindFunction = function (links) {
        $.each(links, function (k, v) {
            var mstParamString = isUrl ? $(v).attr("href") : XIAOMI.lang.trim($(v).text()),
                BDparamString = isBDurl ? $(v).attr("href") : XIAOMI.lang.trim($(v).text()), paramIndex = k,
                BDparmas_1 = _this.options.page,
                BDparmas_2 = BDparmas_1 + "_" + _this.options.position[i] + "_" + paramIndex,
                BDparmas_3 = BDparmas_2 + "_" + BDparamString, BDparmas = "'PC','" + BDparmas_3 + "'",
    ...
    init: function (options) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                return _this.inTheQueue ? (data.login === !1 && (location.href = XIAOMI.GLOBAL_CONFIG.orderSite + "/site/login?redirectUrl=" + location.href), isOver === !0 ? (_this.stopQueue(), alert("抱歉，商品已售罄！"), !1) : (_this.getDmTimer && clearTimeout(_this.getDmTimer), void (token ? _this.getShopCart(token) : (_this.inTheQueue || _this.startQueue(), _this.getDmTimer = setTimeout(function () {
                    _this.getDmSys()
                }, speed))))) : !1
            }
        })
    ...
    init: function () {
        var _this = this;
        _this.retinizer(), _this.modalCommonTrack(), _this.siteList(), XIAOMI.app.analytics([".J_menuNavMain"], {
            page: "导航",
            position: ["A"],
            mstPage: "HP",
            mstArea: "NV",
    ...
    updateDom: function (uid) {
        ...
        var timeoutUserMenu,
            html = '欢迎您 <b class="user-name">' + displayName + '<span class="arrow"></span></b><span class="sep">|</span><a href="http://static.mi.com/order/">我的订单</a><span class="sep">|</span><a href="http://account.xiaomi.com/" target="_blank">我的小米账户</a>',
