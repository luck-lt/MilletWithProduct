...
(function () {
    ...
    function p(e) {
        var t = document.cookie, n = d(t), r = n.split(";");
    ...
    function y() {
        var e = new Date, t = e.getTime() + "_" + Math.round(Math.random() * 1e4);
        return t
    }
    ...
    function E() {
        var e = document.location.href.replace(/&/g, "|"), t = document.referrer.replace(/&/g, "|");
        t = t.toLowerCase();
        if (t) {
            var n = g(t), r = p("lastsource");
            r && h("lastsource", r, u()), (n.indexOf(".mi.com") < 0 || n.indexOf("s1.mi.com") > -1 || n.indexOf("p.www.xiaomi.com") > -1 || n.indexOf("a.union.mi.com") > -1) && h("lastsource", n, u())
        }
        var i = p("xm_www_sid"), d = p("mstuid"), m = p("muuid"), b = p("mucid"), w = p("mutid"), E = p("mstz") || "";
        if (E === "" || E.split("|").length < 3) {
            var T = [];
            T[0] = "", T[1] = "", T[2] = v().toString() + "." + 0;
            var N = "mstz", C = T.join("|");
            h(N, C, u())
        }
        E = p("mstz");
        var k = E.split("|") || [], L = k.length == 4 ? 0 : 1, A = k[0] || "", O = k[1] || "", M = [];
        M = k[2].split(".");
        var _ = M[0], D = parseInt(M[1]) + 1;
        k[2] = M[0] + "." + D.toString();
        var P = k[3] || "", H = k[4] || "", B = k[5] || "", j = 0, F = encodeURIComponent(t);
        F == "" && (H = "", B = ""), F != H && e != t ? (B = H, H = F) : F != "" && (j = 1), k[3] = P, k[4] = H, k[5] = B, h("mstz", k.join("|"), u());
        var I = p("lastsource"), q = 0, R = new Date;
        R.setTime(R.getTime() + 62208e6), d === "" && (q = 1, d = y()), h("mstuid", d, u(), R.toGMTString());
        var U = "", z = new Date;
        return s.curl === undefined || s["curl"] == "" ? s.curl = location.href : s.curl = s.curl, s.xmv = x(d), s.v = o, s.vuuid === undefined && (s.vuuid = S(16, 32)), U = "mid=" + p("userId") + "&phpsessid=" + i + "&mstuid=" + d + "&muuid=" + m + "&mucid=" + b + "&sessionId=" + _ + "&step=" + D + "&new_visitor=" + q + "&mstprevpid=" + encodeURIComponent(A) + "&mstprev_pid_loc=" + P + "&prevtarget=" + O + "&lastsource=" + I + "&timestamp=" + z.getTime() + "&ref=" + F + "&domain=" + u() + "&screen=" + c() + "&language=" + a() + "&vendor=" + f() + "&platform=" + l() + "&gu=" + B + "&pu=" + H + "&rf=" + j + "&mutid=" + w, U
    }
    ...
    function x(e) {
        var t = p("xm_vistor"), n = !0, r = "", i = 0, s = (new Date).getTime();
        if (t !== "") {
            var o = t.split("-");
            o.length == 2 && (r = o[0], i = o[1], s - i <= 18e5 && (n = !1))
        }
        return n && (r = e + "_" + s), i = s, h("xm_vistor", r + "-" + i, u()), r
    }

    function T() {
        var e = window.performance || window.webkitPerformance, e = e && e.timing;
        if (!e) return "";
        var t = e.navigationStart, n = [];
        n.ldns = e.domainLookupEnd - e.domainLookupStart, n.con = e.connectEnd - e.connectStart, n.res = e.responseStart - e.requestStart, n.down = e.responseEnd - e.responseStart, n.redi = e.fetchStart - t;
        var r = "";
    ...
    function _(e, t) {
        ...
        n = document.createElement("script"), n.async = "async", n.src = e, n.onload = n.onreadystatechange = function () {
            if (!n.readyState || /loaded|complete/.test(n.readyState)) n.onload = n.onreadystatechange = null, r && n.parentNode && r.removeChild(n), n = undefined, t()
    ...
    function j() {
        var e = /\/(index.php|index.html|index.htm|index)$/, t = location.protocol + "//", n = location.host,
            r = location.pathname.replace(e, "/"), i = t + n + r;
        return md5("undefined" != typeof _STAT_HASHNAME && "" != _STAT_HASHNAME ? _STAT_HASHNAME : i)
    }

    var e = "prototype", t = Math, n = "", r = "", s = [], o = "1.4.09", k = function () {
        this.p = []
    }, L = k[e], A = /^AA\d+$/, O = "(http|https)://item.mi.com/([0-9]+).html.*";
    O = new RegExp(O);
    var M = new Object;
    L.trackPerformance = function (e) {
        ...
        var t = e[0], n = encodeURIComponent(e[1]), r = document.getElementById(t);
        if ("undefined" != typeof r && r != null) try {
            var i = r.getElementsByTagName("a"), s = "", o = E() + b(), u = 0;
            for (var a = 0; a < i.length; a++) {
                var f = i[a].getAttribute("data-stat-pid"), l = i[a].getAttribute("data-stat-aid");
                if (f != null && l != null) {
                    var c = i[a].getAttribute("href"), h = l + "+" + f;
                    if ("undefined" == typeof M[h]) {
                        if (O.test(c)) {
                            var p = O.exec(c);
                            "object" == typeof p && p.length >= 3 && (c = p[2])
                        }
                        s += l + "+" + f + "+" + c + ";", u++, M[h] = 1, u % 20 == 0 && s != "" && (N(F + o + "&type=sp&spt=" + n + "&log=" + encodeURIComponent(s)), s = "")
                    }
                }
            }
        ...
        var t = T();
        N(F + e + t + varParam);
        var n = new Date, r = encodeURIComponent(window.location.href);
        n.setTime(n.getTime() + 18e4), h("msttime", r, u(), n.toGMTString()), n.setTime(n.getTime() - 12e4), h("msttime1", r, u(), n.toGMTString())
    }, L.push = function (e) {
        if (C(e[0])) {
            e[0](e.slice(1));
            return
        ...
        var t = "", n = "", r = "", i = "", s = "", o = "", d = new Date, m = p("mstz").split("|") || [], g = "",
            y = "", w = "", E = "", S = 0;
        m.length >= 3 && (g = m[0], y = m[1], w = m[2].split(".")[0] || v().toString() + "." + 0);
        var x = e.length == 4 ? 1 : 0;
        if (x) t = e[1], s = e[2], r = encodeURIComponent(e[3]), g != s && (m[0] = s, S = 1); else {
            n = e[0], r = encodeURIComponent(e[1]), i = e[2], m[0] = n, E = m[3] || "", E != i && (m[3] = i, S = 1);
            var T = [];
            T = m[2].split("."), w = T[0]
        }
        var d = new Date, C = p("xm_www_sid");
        y != r && (m[1] = r, S = 1), S && h("mstz", m.join("|"), u());
    ...
    (function (e) {
        ...
        window.md5 = b, typeof define == "function" && define.amd ? define(function () {
            return b
        }) : e.md5 = b
    })(this);
    var F = "//a.stat.xiaomi.com/js/mstr.js?", I = new k;
    I.p = window._msq;
    if ("undefined" != typeof window._msq) for (i = 0; i < I.p.length; i++) I.push(I.p[i]);
    window._msq = I, (s["domain_id"] == 100 || s["domain_id"] == 101) && w("//c1.mifile.cn/f/i/15/stat/js/unjcV2.js")
})();