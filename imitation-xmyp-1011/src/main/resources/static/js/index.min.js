XIAOMI.namespace("app.formatter, app.recharge"), XIAOMI.app.formatter = {
...
;XIAOMI.namespace("mhome"), XIAOMI.mhome = {
    randomHdShow: function (el) {
        ...
        var oDate = new Date,
            indexMiscDataVersion = [oDate.getFullYear(), oDate.getMonth() + 1, oDate.getDate(), oDate.getHours(), parseInt(oDate.getMinutes() / 10)];
        $.ajax({
            type: "GET",
            url: XIAOMI.GLOBAL_CONFIG.wwwSite + "/c/service/js/indexMiscData.js?ver=" + indexMiscDataVersion.join(""),
            dataType: "script",
            cache: !0,
            error: function () {
            },
        ...
        $.ajax({
            type: "GET",
            url: XIAOMI.GLOBAL_CONFIG.itemSite + "/comment/total/id/" + cidStr,
            dataType: "jsonp",
    ...
    function initCarousel() {
        XIAOMI.app.carousel.init($starGoodsCarousel, {itemSelector: ".xm-star-goods-item"})
    }
    ...
    $("#J_homeSlider").xmSlide({
    ...
    }), XIAOMI.mhome.randomHdShow($(".J_randomItem")), initCarousel(), $(window).on("resize.carousel", function () {
        ...
        isMst: !0
    }), XIAOMI.app.analytics([".site-topbar", ".open-buy-info", ".site-logo", ".cart-section", ".footer-links", ".footer-info"], {
